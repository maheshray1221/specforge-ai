export const openApiDocument = {
  ...
  paths: {
    ...
    "/projects/{projectId}/members/{memberId}": {
      patch: { tags: ["Collaboration"], summary: "Update workspace member role", security: [{ bearerAuth: [] }], parameters: [{ in: "path", name: "projectId", required: true, schema: { type: "string", format: "uuid" } }, { in: "path", name: "memberId", required: true, schema: { type: "string", format: "uuid" } }], responses: { "200": { description: "Member updated" } } },
      delete: { tags: ["Collaboration"], summary: "Remove workspace member", security: [{ bearerAuth: [] }], parameters: [{ in: "path", name: "projectId", required: true, schema: { type: "string", format: "uuid" } }, { in: "path", name: "memberId", required: true, schema: { type: "string", format: "uuid" } }], responses: { "204": { description: "Member removed" } } },
    },
