  ...
  useEffect(() => {
    ...
    void Promise.resolve()
      .then(() => {
        setLoading(true);
        setError("");
        return api<{ projects: Project[] }>(`/projects?workspaceId=${workspace.id}&status=ACTIVE`);
      })
